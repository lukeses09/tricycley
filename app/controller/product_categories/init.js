...
function load(){
menu_settings.page_name("Product Categories");
populate_table_main();
menu_settings.menu_name2("maintenance","pcategories");
}
...
function populate_table_main(){
	...
	$.ajax ({
	  type: "POST",
	  url: "../../model/product_category/populate_table_main.php",
	  dataType: 'json',
	  cache: false,
	  success: function(s)
	  {
...
function save_form_class(){
    ...
    // console.log(dataString)
		...
		$.ajax ({
		  type: "POST",
		  url: "../../model/product_category/create.php",
		  data: dataString,
		  // dataType: 'json',
		  success: function(x){
      // console.log(x)
    ...
    // console.log(dataString)
		...
		$.ajax ({
		  type: "POST",
		  url: "../../model/product_category/update.php",
		  data: dataString,
		  // dataType: 'json',
		  success: function(x){
		  	if(x==0)
...
function row_update(id){
	...
	$.ajax ({
	  type: "POST",
	  url: "../../model/product_category/fetch.php",
	  data: 'id='+id,
	  dataType: 'json',
	  cache: false,
	  success: function(s){
...
function delete_form_class(id){
		...
		$.ajax ({
		  type: "POST",
		  url: "../../model/product_category/delete.php",
		  data: 'id='+id,
		  // dataType: 'json',
		  cache: false,
		  success: function(x){
