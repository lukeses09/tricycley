...
function load(){
menu_settings.page_name("Positions");
populate_table_main();
menu_settings.menu_name2("maintenance","position");
}
...
function populate_table_main(){
	...
	$.ajax ({
	  type: "POST",
	  url: "../../model/position/populate_table_main.php",
	  dataType: 'json',
	  cache: false,
	  success: function(s)
	  {
