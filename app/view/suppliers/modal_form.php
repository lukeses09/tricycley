  ...
  <div class="modal-dialog">
    <div class="modal-content" >
        <div class="modal-header">
            ...
            <h4 class="modal-title"> <i class="ti-pencil-alt"></i> Supplier Form: </h4>
        </div>
  ...
  <div class="row">
      <div class="col-md-12">
          <div class="form-group">
              <label>Supplier Name</label> <star>*</star>
              <input id="f_name" name="f_name" class="form-control border-input" placeholder="Input Supplier Name" required>
          </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
      ...
      <div class="col-md-12">
          <div class="form-group">
              ...
              <input id="f_contact_person" name="f_contact_person" class="form-control border-input" placeholder="Input Contact Person"></textarea>
          </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
              <label>Contact Number</label>
              <input id="f_contact_no" name="f_contact_no" type="number" class="form-control border-input" placeholder="e.g. 09063402309" min="1" minLength="11" maxlength="11"></textarea>
          </div>
      </div>
     <!--  <div class="col-md-12">
          <div class="form-group">
