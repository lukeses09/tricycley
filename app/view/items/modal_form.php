  ...
  <div class="modal-dialog">
    <div class="modal-content" >
        <div class="modal-header">
            ...
            <h4 class="modal-title"> <i class="ti-pencil-alt"></i> Product Form: </h4>
        </div>
  ...
  <div class="row">
      <div class="col-md-12">
          <div class="form-group">
              <label>Item Description</label> <star>*</star>
              <input id="f_name" name="f_name" class="form-control border-input" placeholder="Input Product Name/Description" required>
          </div>
      </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-6">
          <div class="form-group">
              ...
              <input id="f_no_items" name="f_no_items" type="number" class="form-control border-input" placeholder="Input Number of Product" min="1" required/>
          </div>
      </div>
