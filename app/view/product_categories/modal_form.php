  ...
  <div class="modal-dialog">
    <div class="modal-content" >
        <div class="modal-header">
            ...
            <h4 class="modal-title"> <i class="ti-pencil-alt"></i> Category Form: </h4>
        </div>
  ...
  <div class="row">
      <div class="col-md-12">
          <div class="form-group">
              <label>Category Name</label> <star>*</star>
              <input id="f_name" name="f_name" class="form-control border-input" placeholder="Input Category Name" required>
          </div>
      </div>
     <!--  <div class="col-md-12">
          <div class="form-group">
