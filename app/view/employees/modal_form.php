  ...
  <div class="modal-dialog">
    <div class="modal-content" >
        <div class="modal-header">
            ...
            <h4 class="modal-title"> <i class="ti-pencil-alt"></i> Employee Form: </h4>
        </div>
  ...
  <div class="row">
      <div class="col-md-12">
          <div class="form-group">
              ...
              <input id="f_name" name="f_name" class="form-control border-input" placeholder="Input Employee Name" required>
          </div>
      </div>
      <div class="col-md-12">
          <div class="form-group">
  ...
  <div class="row">
      ...
      <div class="col-md-6">
          <div class="form-group">
              ...
              <select id="f_position" name="f_position"  class="form-control border-input" placeholder="Choose Position" required disabled>
                <option value="PS17592e977386da0" selected>Instructor</option>
              </select>
         </div>
        </div>
      </div>
